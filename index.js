...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'http://localhost:2000/parse',  // Don't forget to change to https if needed
  liveQuery: {
...
var port = process.env.PORT || process.env.PORT_ENV || 1337;
